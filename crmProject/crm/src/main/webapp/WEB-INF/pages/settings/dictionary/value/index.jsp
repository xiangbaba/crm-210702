...
<div style="position: relative; left: 30px; top: 20px;">
    <table class="table table-hover">
        ...
        <tr style="color: #B3B3B3;">
            <td><input type="checkbox" id="allValue"/></td>
            <td>序号</td>
            <td>字典值</td>
            <td>文本</td>
            <td>排序号</td>
        ...
        <tbody id="tBody">
        <c:forEach items="${pageInfo.list}" var="dv" varStatus="vs">
...
<div class="box-tools pull-left" >
    <ul class="pagination">
        <li>
            <a href="settings/dictionary/value/index.do?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
        </li>
        <li><a href="settings/dictionary/value/index.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
        <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
            <li><a href="settings/dictionary/value/index.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
        </c:forEach>
        <li><a href="settings/dictionary/value/index.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
        <li>
            <a href="settings/dictionary/value/index.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
        </li>
    </ul>
</div>
</div>
