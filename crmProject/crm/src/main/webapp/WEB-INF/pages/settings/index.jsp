			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						失效时间：<b>${sessionScope.sessionUser.createTime}</b><br><br>
						允许访问IP：<b>${sessionScope.sessionUser.allowIps}</b>姓名：<b>${sessionScope.sessionUser.name}</b><br><br>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="updateNewPass">更新</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="javascript:fun()" data-toggle="modal" data-target="#editPwdModal"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
