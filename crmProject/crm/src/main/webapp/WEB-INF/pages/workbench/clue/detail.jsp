...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#searchActivityName").keyup(function () {
            ...
            //发送请求
            $.ajax({
                url:'workbench/clue/selectUncorrelatedActivityByClueIdAndName.do',
				data:{
		...
		$("#relationTBody").on("click","a",function () {
			...
			if (window.confirm("确定解除吗？")){
				//发送请求
				$.ajax({
					url:'workbench/clue/dissociatedActivity.do',
					data:{
		...
		<c:forEach items="${remarkList}" var="remark">
			<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.editFlag==0?remark.createTime:remark.editTime} 由${remark.editFlag==0?remark.createBy:remark.editBy}${remark.editFlag==0?'创建':'修改'}</small>
